...
void SelectObject::onPluginLoad()
{
    ...
    vs->compileSourceFile("plugins/selectObject/selectObject.vert");
     cout << "VS log:" << vs->log().toStdString() << endl;
    fs = new QOpenGLShader(QOpenGLShader::Fragment, this);
    fs->compileSourceFile("plugins/selectObject/selectObject.frag");
...
void SelectObject::update()
{
    glwidget()->update();
}

void SelectObject::calcularPosicion(const Object& obj) 
{
...
Q_EXPORT_PLUGIN2(SelectObject, SelectObject)   // plugin name, plugin class
#endif

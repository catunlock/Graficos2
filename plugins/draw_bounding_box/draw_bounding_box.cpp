...
void Draw_bounding_box::onPluginLoad()
{
    ...
    vs->compileSourceFile("plugins/draw_bounding_box/draw_bounding_box.vert");
     cout << "VS log:" << vs->log().toStdString() << endl;
    fs = new QOpenGLShader(QOpenGLShader::Fragment, this);
    fs->compileSourceFile("plugins/draw_bounding_box/draw_bounding_box.frag");
...
void Draw_bounding_box::crearCubo()
{
    GLWidget &g = *glwidget();
    g.makeCurrent();
...
void Draw_bounding_box::update()
{
    glwidget()->update();
}

void Draw_bounding_box::calcularPosicion(const Object& obj) 
{
...
Q_EXPORT_PLUGIN2(Draw_bounding_box, Draw_bounding_box)   // plugin name, plugin class
#endif
